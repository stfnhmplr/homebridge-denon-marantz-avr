...
function MainZoneAccessory (homebridge) {
  Characteristic = homebridge.hap.Characteristic;
  Service = homebridge.hap.Service;
  return MainZoneAccessory$1;
}

var MainZoneAccessory$1 =
/*#__PURE__*/
function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this.platform.send(`MU${state ? 'ON' : 'OFF'}`);
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this.log(`setting power state of main zone to ${state}`);

                _this.platform.send(`PW${state ? 'ON' : 'STANDBY'}`);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _this.log(`set volume of main zone to ${value} (${vol / 10})`);

                _this.platform.send(`MV${vol}`);
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _this.log(`setting input source of main zone to ${value}`);

                _this.platform.send(`SI${value.toUpperCase()}`);
  ...
  _createClass(MainZoneAccessory, [{
    ...
    value: function handleResponse(res) {
      var regExp = /MUON|MUOFF|PWON|PWSTANDBY|MV\d{1,3}/gm;
...
module.exports = MainZoneAccessory;
